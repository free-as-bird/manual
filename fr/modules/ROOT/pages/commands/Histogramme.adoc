...
L'aire totale de l'histogramme est 0.5*10 + 0.2*10 + 0.1*10 = 8. Cette valeur est affichée dans Algèbre.
...
Cet histogramme ne prend pas en compte la densité, les hauteurs des barres sont les effectifs de chacune des classes. Vous pouvez lire le nombre total de valeurs dans Algèbre.
